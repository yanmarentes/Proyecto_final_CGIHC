...
bool Texture::LoadTextureA()
{
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);// eje S paralelo a X, repetir sobre el eje
...
*/
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);// eje T paralelo a Y, repetir sobre el eje
